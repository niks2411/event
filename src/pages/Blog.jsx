...
const posts = [
    ...
    { title: 'How to Plan the Perfect Haldi Ceremony', category: 'Traditions', date: 'Feb 5, 2026', img: 'https://res.cloudinary.com/dpvbnp8s3/image/upload/v1773400465/haldi_evqqdk.webp', excerpt: 'A complete guide to planning a vibrant and traditional haldi ceremony with modern touches.' },
    { title: 'Fireworks Safety: Everything You Need to Know', category: 'Safety', date: 'Jan 28, 2026', img: 'https://res.cloudinary.com/dpvbnp8s3/image/upload/v1773400464/fire_cmv6ch.webp', excerpt: 'Essential safety tips and guidelines for spectacular yet safe fireworks displays at events.' },
